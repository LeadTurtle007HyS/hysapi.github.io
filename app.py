...
def delete_user_epub_selected_text():
    ...
    @cross_origin()
    def web_add_user_preferred_language_data():
        conn = None
        cursor = None
        try:
            _json = request.json
    ...
    def web_add_user_question_details():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                data = (
                    _question_id, _user_id, _answer_count, _answer_preference, _audio_reference, _call_date,
                    _call_end_time,
                    _call_now, _call_preferred_lang, _call_start_time, _answer_credit, _question_credit, _view_count,
                    _examlikelyhood_count, _grade, _like_count, _note_reference, _ocr_image, _compare_date, _question,
                    _question_type, _is_identity_visible, _subject, _topic, _text_reference, _toughness_count,
    ...
    def web_add_users_tagged_in_question():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                ...
                cursor = conn.cursor()
                cursor.execute(
                    "insert into u736502961_hys.users_tagged_with_question(question_id, user_id) values (%s, %s);",
                    data)
                conn.commit()
                resp = jsonify('Users tagged with question added successfully!')
                resp.status_code = 200
    ...
    def web_update_counts_in_question_details():
        ...
        try:
            ...
            if _user_id and request.method == 'PUT':
                data = (
                    _answer_count, _view_count, _examlikelyhood_count, _like_count, _toughness_count, _impression_count,
                    _user_id, _question_id)
                conn = mysql.connect()
                cursor = conn.cursor()
                cursor.execute(
    ...
    def web_post_answer_on_question_details():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                data = (
                    _answer_id, _question_id, _user_id, _comment_count, _audio_reference, _like_count, _upvote_count,
                    _downvote_count, _note_reference, _image, _compare_date, _answer, _answer_type, _text_reference,
                    _video_reference)
                conn = mysql.connect()
                cursor = conn.cursor()
    ...
    def web_add_users_tagged_in_answer():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                ...
                cursor = conn.cursor()
                cursor.execute(
                    "insert into u736502961_hys.users_tagged_with_answer(answer_id, user_id) values (%s, %s);",
                    data)
                conn.commit()
                resp = jsonify('Users tagged with answer added successfully!')
                resp.status_code = 200
    ...
    def web_add_users_answer_comment():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                data = (
                    _comment_id, _answer_id, _question_id, _user_id, _comment, _comment_type, _like_count, _reply_count,
    ...
    def web_add_sm_mood_details():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                data = (
                    _post_id, _user_id, _message, _user_mood, _imagelist_id, _videolist_id, _usertaglist_id, _privacy,
                    _like_count, _comment_count, _view_count, _impression_count, _compare_date)
                conn = mysql.connect()
                cursor = conn.cursor()
                cursor.execute(
    ...
    def web_add_sm_post_videos():
        ...
        try:
            ...
            if request.method == 'POST':
                ...
                cursor = conn.cursor()
                cursor.execute(
                    "insert into u736502961_hys.sm_post_videos(videolist_id, video, thumbnail) values(%s ,%s,%s);",
                    data)
                conn.commit()
                resp = jsonify('post details added successfully!')
                resp.status_code = 200
    ...
    def web_add_sm_post_users_tagged():
        ...
        try:
            ...
            if request.method == 'POST':
                ...
                cursor = conn.cursor()
                cursor.execute(
                    "insert into u736502961_hys.sm_post_users_tagged(usertaglist_id, user_id) values(%s ,%s);",
                    data)
                conn.commit()
                resp = jsonify('post details added successfully!')
                resp.status_code = 200
    ...
    def web_add_user_sm_comment_details():
        ...
        try:
            ...
            if request.method == 'POST':
                data = (
                    _comment_id, _post_id, _user_id, _comment, _imagelist_id, _videolist_id, _usertaglist_id,
                    _like_count,
                    _reply_count, _compare_date)
                conn = mysql.connect()
                cursor = conn.cursor()
    ...
    def web_add_user_sm_reply_details():
        ...
        try:
            ...
            if request.method == 'POST':
                data = (
                    _reply_id, _comment_id, _post_id, _user_id, _reply, _imagelist_id, _videolist_id, _usertaglist_id,
                    _like_count, _compare_date)
                conn = mysql.connect()
                cursor = conn.cursor()
                cursor.execute(
    ...
    def web_add_user_sm_cause_details():
        ...
        try:
            ...
            if request.method == 'POST':
                data = (
                    _post_id, _user_id, _message, _datetime, _address, _date, _eventcategory, _eventname,
                    _eventsubcategory,
                    _eventtype, _feedtype, _frequency, _from_, _from24hrs, _fromtime, _grade, _latitude, _longitude,
                    _meetingid,
                    _subject, _theme, _themeindex, _to_, _to24hrs, _totime, _imagelist_id, _videolist_id,
                    _usertaglist_id,
                    _privacy, _like_count, _comment_count, _view_count, _impression_count, _compare_date)
                conn = mysql.connect()
                cursor = conn.cursor()
    ...
    def web_add_user_sm_bideas_details():
        ...
        try:
            ...
            if request.method == 'POST':
                data = (
                    _post_id, _user_id, _content, _theme, _title, _identification, _solution, _target, _competitors,
                    _swot,
                    _strategy, _funds, _documentlist_id, _videolist_id, _memberlist_id, _privacy, _like_count,
                    _comment_count,
                    _view_count, _impression_count, _compare_date)
    ...
    def web_add_user_sm_project_details():
        ...
        try:
            ...
            if request.method == 'POST':
                data = (
                    _post_id, _user_id, _content, _theme, _title, _grade, _subject, _topic, _requirements,
                    _purchasedfrom,
                    _procedure, _theory, _findings, _similartheory, _memberlist_id, _projectvideourl, _reqvideourl,
                    _summarydoc,
                    _otherdoc, _privacy, _like_count, _comment_count, _view_count, _impression_count, _compare_date)
    ...
    def web_add_user_sm_uploads_details():
        ...
        try:
            ...
            if request.method == 'POST':
                data = (
                    _upload_id, _upload_type, _user_id, _school_name, _exam_name, _grade, _subject, _chapter, _topic,
                    _term,
                    _year, _tags, _description, _compare_date)
                conn = mysql.connect()
                cursor = conn.cursor()
    ...
    def web_add_sm_blog_post_details():
        ...
        try:
            ...
            if _user_id and request.method == 'POST':
                data = (
                    _post_id, _user_id, _blogger_name, _blog_title, _blog_intro, _blog_content, _like_count,
                    _comment_count,
                    _view_count, _impression_count, _compare_date)
                conn = mysql.connect()
                cursor = conn.cursor()
        ...
        try:
            ...
            if request.method == 'POST':
                ...
                if _do_post == 'TRUE':
                    ...
                    data = (_post_id, _user_id)
                    cursor.execute("delete from u736502961_hys.sm_post_like_details where post_id=%s and user_id=%s;",
                                   data)
